...
export default function TaskList({
  ...
  const handleSelfCheck = async (task: TaskView) => {
    ...
    const loadingToast = toast({
      title: "Processing",
      description: "Checking your submission...",
    });
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Self check completed successfully",
      });
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Failed to complete self check",
        variant: "destructive"
      });
    }
  };
