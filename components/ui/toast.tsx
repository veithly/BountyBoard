...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={cn(
      ...
      "sm:right-0 sm:top-0 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
...
const toastVariants = cva(
  cn(
    ...
    "overflow-hidden rounded-xl border p-6 pr-8 shadow-lg transition-all",
    "backdrop-blur-md",
    // Animation
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "px-3 text-sm font-medium text-purple-200",
      "transition-colors",
      "hover:bg-purple-500/20",
      "focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2",
      "disabled:pointer-events-none disabled:opacity-50",
      // Destructive styles
      "group-[.destructive]:border-red-500/20",
      "group-[.destructive]:bg-red-500/10",
      "group-[.destructive]:text-red-300",
      "group-[.destructive]:hover:bg-red-500/20",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      // Destructive styles
      "group-[.destructive]:text-red-300/50",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ...
    className={cn(
      "text-sm",
      "text-purple-300/70",
      "group-[.destructive]:text-red-300/70",
      className
    )}
    {...props}
  />
