...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "text-purple-200 data-[state=open]:text-purple-100",
      "focus:bg-purple-500/20 data-[state=open]:bg-purple-500/20",
  ...
  >
    {children}
    <ChevronRight className="ml-auto h-4 w-4 text-purple-300/70" />
  </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "border border-purple-500/20 bg-black/80 backdrop-blur-md",
      "text-purple-100 shadow-lg shadow-black/20",
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-md p-1",
        "border border-purple-500/20 bg-black/80 backdrop-blur-md",
        "text-purple-100 shadow-lg shadow-purple-500/10",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "text-purple-200 focus:text-purple-100",
      "focus:bg-purple-500/20",
      "transition-colors duration-200",
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("ml-auto text-xs tracking-widest text-purple-300/50", className)}
      {...props}
    />
  )
}
