...
export const discordAnnouncementTemplate =
    `
# Task: Format an announcement message for {{agentName}}
About {{agentName}}:
{{bio}}
...
# Instructions:
1. Format this announcement in {{agentName}}'s voice and style
2. Structure the message appropriately for the announcement type:
   - NOTICE: Important information that needs attention
   - EVENT: Upcoming events or activities
   - UPDATE: Changes or updates to systems/rules
   - GENERAL: Regular announcements
3. Use appropriate formatting:
   - Use bold for important points
   - Use bullet points for lists
   - Add appropriate emojis if suitable
4. Include:
   - Clear header/title
   - Main content
