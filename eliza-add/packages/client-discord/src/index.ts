import { getEmbeddingZeroVector, Memory } from "@ai16z/eliza";
...
import chat_with_attachments from "./actions/chat_with_attachments.js";
import download_media from "./actions/download_media.js";
import joinvoice from "./actions/joinvoice.js";
import leavevoice from "./actions/leavevoice.js";
import summarize from "./actions/summarize_conversation.js";
import transcribe_media from "./actions/transcribe_media.js";
import announcement from "./actions/announcement.js";
import { MessageManager } from "./messages.js";
import channelStateProvider from "./providers/channelState.js";
import voiceStateProvider from "./providers/voiceState.js";
import { VoiceManager } from "./voice.js";
import { PermissionsBitField } from "discord.js";
import { sendMessageInChunks } from "./utils.js";
...
export class DiscordClient extends EventEmitter {
    ...
    constructor(runtime: IAgentRuntime) {
        ...
        this.runtime.registerAction(announcement);
    ...
    async sendAnnouncement(
        channelId: string,
        content: string,
        type: "notice" | "event" | "update" | "general" = "general"
    ) {
        try {
            ...
            elizaLogger.error("Error sending announcement:", error);
            throw error;
        }
    }
}
